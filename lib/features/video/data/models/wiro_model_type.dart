...
enum WiroModelType {
  textAnimations(
    ...
    'video-titles-with-only-title-input',
  ),
  productAds(
    'wiro/product-ads',
    'Product Ads',
    ...
    'product-ads-with-only-image-input',
  ),
  productAdsWithCaption(
    ...
    'product-ads-with-title-and-image-input',
  ),
  productAdsWithLogo(
    ...
    'product-ads-with-two-images-input',
  );
  ...
  String getCoverUrl(String effectValue) =>
      '$cdnBase/$coverFolder/$effectValue.mp4';
